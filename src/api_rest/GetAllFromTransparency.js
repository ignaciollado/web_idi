...
//---------------------------------------------------------------------------------
import '../css/getallfromtransparency.css'
...
function serviceClass (category) {
    ...
    return (
        <div className="getallpostfromtransparency">
        <div className="getallpostfromtransparency__cabecera">
...

            {
                ...
                (
                    allpostbycategory.map(((allpostbycategory) => (
                        <div className="getallpostfromtransparency__item" key={allpostbycategory.id} id={allpostbycategory.id} dangerouslySetInnerHTML={
                            { __html: `
                            <a id="info" href=gettransparencydetail/${allpostbycategory.slug}/${category}>
                            <figure>
